...
- The full-screen header now provides a high-contrast, labeled **Close & return** action. Browser verification confirmed it is visible above the transaction list and returns directly to the Agent Leaderboard when selected.
