...
function HomeContent() {
  ...
  // Dotloop OAuth connection (localStorage-based)
  ...
  const connectDotloop = () => {
    console.log('[OAuth] Redirecting to Dotloop OAuth...');
    
    // Generate authorization URL directly on frontend
  ...
  // Remove the old tRPC-based connection status check
