        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 border rounded bg-background">
              <div className="text-sm text-foreground/70">Total Records</div>
              <div className="text-2xl font-bold">{totalRows}</div>
            </div>
            <div className="p-4 border rounded bg-background">
              <div className="text-sm text-foreground/70">Missing Dates</div>
              <div className={`text-2xl font-bold ${missingDates > 0 ? 'text-amber-600' : 'text-emerald-600'}`}>
                {missingDates}
              </div>
            </div>
            <div className="p-4 border rounded bg-background">
              <div className="text-sm text-foreground/70">Missing Prices</div>
