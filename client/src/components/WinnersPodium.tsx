  ...
  return (
    <div className="w-full bg-gradient-to-b from-blue-50/50 to-transparent rounded-xl p-8 mb-8">
      ...
      >
        ...
        <motion.div 
          variants={item} 
          className="flex flex-col items-center w-1/3 max-w-[200px] cursor-pointer group"
        ...
        <motion.div 
          variants={item} 
          className="flex flex-col items-center w-1/3 max-w-[200px] z-10 cursor-pointer group"
