    ...
    <Card className="w-full max-w-4xl mx-auto shadow-lg border-border bg-card">
      <CardHeader>
        <div className="flex justify-between items-center">
          ...
          <div className="text-sm text-foreground/70 bg-muted px-3 py-1 rounded-full">
                  ...
                  {group.fields.map((field) => (
                    <div key={field.key} className="space-y-2 p-3 rounded-lg border border-border/50 hover:border-border transition-colors bg-card/50">
                      ...
                      >
                        ...
                        <SelectContent>
                          <SelectItem value="unmapped" className="text-foreground/70 italic">
                            -- Not Mapped --
                          </SelectItem>
                          {headers.map((header) => (
                            <SelectItem key={header} value={header}>
                              ...
                              {samples[header] && (
                                <span className="ml-2 text-xs text-foreground/70 truncate max-w-[200px] inline-block align-bottom">
      ...
      <CardFooter className="flex justify-between border-t border-border pt-6">
        <Button variant="ghost" onClick={handleReset} className="text-foreground/70 hover:text-foreground">
