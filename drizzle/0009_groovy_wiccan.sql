DROP TABLE `tier_history`;--> statement-breakpoint
...
ALTER TABLE `commission_plans` DROP COLUMN `useSliding`;--> statement-breakpoint
ALTER TABLE `commission_plans` DROP COLUMN `tiers`;